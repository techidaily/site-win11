---
title: Routine Task for Eliminating Steam DNS Cache on PC
date: 2024-07-13T10:08:17.240Z
updated: 2024-07-14T10:08:17.240Z
tags:
  - windows10
  - windows11
categories:
  - os
  - windows 11
description: This Article Describes Routine Task for Eliminating Steam DNS Cache on PC
excerpt: This Article Describes Routine Task for Eliminating Steam DNS Cache on PC
keywords: Clear DNS Steam Cache,Remove Steam DNS Cache,Disable DNS Leftovers,Wipe Steam DNS Data,Unlink Steam DNS Entries,Purge Steam DNS Cache,Delete Steam DNS Records
thumbnail: https://thmb.techidaily.com/8fe26e0805ce05f014893fbbb4d4db477ab6f4023c6f698c9064238804be4852.jpg
---

## Routine Task for Eliminating Steam DNS Cache on PC

 Steam uses an inbuilt Chrome-based web browser to access features like the store or the friend list. Like any other browser, this can be prone to fail and cause errors. And, like any other browser, sometimes flushing its DNS cache can fix any issues.
...
1. Hit**Win + R** to bring up the**Run** .
2. Type in the following string of text and hit**Enter** :  
`steam://open/console`
