...
date: 2025-01-15T17:50:15.987Z
updated: 2025-01-19T04:38:57.455Z
tags:
  - windows10
  - windows11
categories:
  - os
  - windows 11
description: This Article Describes Modifying Default PDF Application for Windows
excerpt: This Article Describes Modifying Default PDF Application for Windows
keywords: Change PDF Viewer,Default PDF Editor Switch,Alter PDF Viewing Preference,Customize Windows PDF Handler,Set New PDF Application Windows,Adjust Default PDF Display,Alter PDF File View
thumbnail: https://thmb.techidaily.com/74b19b5ea815c7a95f7dc9b836800198030132a31b655195d0378ad85feb1cf9.jpg
---

## Modifying Default PDF Application for Windows
...
2. Take your mouse over the **Open with** option and then select your newly installed driver.
3. If your reader is not there, click **Choose another app** and select your new app from the dialog box.
...
### 2\. From the Settings App
 ...
 To change your Settings app with a PDF reader, follow the steps below:

1. Head to the **Start menu** search bar, type in 'settings', and select the best match.
2. Click on **App** and select **Default apps**.
3. Now scroll down, select the PDF file type, and choose the current default app.
...
### 3\. Use the Control Panel
 ...
 Unsurprisingly, you can also use it here and tweak the default PDF reader with the Control Panel. Here's how you can get started:

1. Head to the **Start menu** search bar, type in the 'control panel', and select the best match.
2. From the Control Panel, select **Programs > Default Programs**.
...
<li><a href="https://fox-http.techidaily.com/updated-2024-approved-ultimate-ringtone-collection-top-download-locales/"><u>[Updated] 2024 Approved Ultimate Ringtone Collection Top Download Locales</u></a></li>
