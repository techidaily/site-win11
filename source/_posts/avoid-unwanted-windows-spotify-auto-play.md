...
date: 2024-06-25T11:33:07.528Z
updated: 2024-06-26T11:33:07.528Z
tags:
  - windows10
  - windows11
categories:
  - os
  - windows 11
description: This Article Describes Avoid Unwanted Windows Spotify Auto-Play
excerpt: This Article Describes Avoid Unwanted Windows Spotify Auto-Play
keywords: Stop Spotify Autoplay,Prevent Music Ads,Disable Playback,Avoid Unsolicited Media,Spotify No Popups,Turn Off Auto-Play,Eliminate Windows Interruptions
thumbnail: https://thmb.techidaily.com/6ef16648595e97873cff52eb597372e60de93b0601596509e90390a2a00c63c2.jpg
---

## Avoid Unwanted Windows Spotify Auto-Play
...
2. Type**Spotify** in the search box and select the first result that appears.
3. In the Spotify app, click the**three-dot menu icon** in the top left corner and select**Edit > Preferences** . Alternatively, you can use the**Ctrl + P** keyboard shortcut to directly open the Preferences menu in the Spotify app.
...
1. Right-click on the**Start icon** to open the Power User menu and select**Task Manager** from the list. Alternatively, you can use the**Ctrl + Shift + Esc** keyboard shortcut to quickly[open the Task Manager app](https://www.makeuseof.com/how-to-access-task-manager-on-windows-11/) .
...
To stop Spotify from opening at startup via the Settings app:

1. Open the**Start menu** and click the**gear icon** to launch the Settings app.
2. Navigate to the**Apps** tab.
3. Select**Startup** from the right pane.
4. Scroll down to locate**Spotify** on the list and disable the toggle next to it.  
...
<li><a href="https://tiktok-video-recordings.techidaily.com/updated-sky-high-engagement-50plus-outstanding-tiktok-username-ideas/"><u>[Updated] Sky-High Engagement  50+ Outstanding TikTok Username Ideas</u></a></li>
<li><a href="https://tiktok-video-recordings.techidaily.com/updated-2024-approved-inspiring-originality-in-tiktok-pfps-to-boost-profile-traction/"><u>[Updated] 2024 Approved  Inspiring Originality in TikTok PFPs to Boost Profile Traction</u></a></li>
</ul></div>
