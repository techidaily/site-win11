---
title: Addressing Non-Displaying Notifications of Phone Link App on PC
date: 2025-02-27T18:34:45.049Z
updated: 2025-03-05T00:52:15.000Z
tags:
  - windows10
  - windows11
categories:
  - os
  - windows 11
description: This Article Describes Addressing Non-Displaying Notifications of Phone Link App on PC
excerpt: This Article Describes Addressing Non-Displaying Notifications of Phone Link App on PC
keywords: Phone Notify No Display PC,Unseen Link App Notifications,Fix PC Notification Hurdle,Address PC Link Alerts,Non-Displaying Phonelink Notified,Enable Link Notifications PC,Resolve Ignored Phone Link Alert
thumbnail: https://thmb.techidaily.com/8ff8906f51872923e9c5692da8760464bdd1f9c3eac0a2d615e95926075c7419.jpg
---

## Addressing Non-Displaying Notifications of Phone Link App on PC
 ...
 To help out, we’ve compiled a list of solutions that will let you fix the Phone Link app notifications in no time.
...
3. Enable the toggle next to**Notifications** .
4. Scroll down to the**Notifications from apps and other senders** section and select the**Phone Link** app.
5. Enable the toggle under**Notifications** .
...
## 2\. Check In-App Notification Settings
 ...
 To check Phone Link’s in-app notification settings, use these steps:

1. Open the Phone Link app on your PC using the search menu.
2. Click the**gear icon** in the top right corner to visit the settings menu.
...
## 3\. Allow Phone Link App to Run in the Background
 ...
 To fix this, you must allow background app permissions for the Phone Link app. Here's how to do it.

1. Right-click on the**Start icon** and select**Settings** from the list.
2. Select**Apps** from the left sidebar.
3. Click on**Installed apps** .
4. Scroll down or use the search bar at the top to locate the**Phone Link** app on the list.
...
## 4\. Disable Battery Saver Mode
 ...
 Enabling the battery-saver mode on Windows can extend the battery life of your laptop by a few extra hours. However, this feature can also prevent apps like Phone Link from syncing data and displaying notifications. To avoid such issues, it’s best to disable the battery-saver mode on Windows.

 You can easily disable the battery-saver mode via the Quick Settings panel. However, if the icon is not visible, follow these steps to turn off battery saver mode.
...
To disable the Do Not Disturb mode, use these steps:
...
<li><a href="https://win11.techidaily.com/enforcing-group-policies-on-a-single-user-written-in-windows-1111-style/"><u>Enforcing Group Policies on a Single User' Written in Windows 11/11 Style</u></a></li>
...
<li><a href="https://win11.techidaily.com/the-most-efficient-windows-laptops-for-maximum-performance/"><u>The Most Efficient Windows Laptops for Maximum Performance</u></a></li>
<li><a href="https://win11.techidaily.com/unveiling-the-secret-to-restoring-thumbnails-in-win-11/"><u>Unveiling the Secret to Restoring Thumbnails in Win 11</u></a></li>
...
<li><a href="https://win11.techidaily.com/windows-11-pin-glitches-quick-remedies/"><u>Windows 11 PIN Glitches: Quick Remedies</u></a></li>
</ul></div>
